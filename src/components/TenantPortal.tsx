...
export const TenantPortal = () => {
  ...
  const curatedColors = [
    { name: 'Ruby Red', value: '#BE3455' },
    { name: 'Ruby Rose', value: '#D4637E' },
      ...
      <AnimatePresence mode="wait">
        {activeTab === 'mailbox' && (
          <motion.div
            ...
            className="relative min-h-[800px] rounded-[4rem] overflow-hidden shadow-2xl bg-[#141414] group"
          >
                      ...
                      return (
                        <motion.button
                          ...
                          style={{ 
                            ...
                            borderColor: isCurrentUser ? '#BE3455' : 'rgba(255,255,255,0.1)'
                          }}
              ...
              <AnimatePresence>
                {selectedMailbox && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0, y: 20 }}
                    className="absolute bottom-12 left-1/2 -translate-x-1/2 w-full max-w-2xl bg-[#141414]/95 backdrop-blur-3xl p-10 rounded-[3.5rem] shadow-2xl border border-white/10 z-50"
                  >
                    <div className="flex items-center justify-between mb-10">
                      <div className="flex items-center gap-5">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] font-bold text-[#BE3455] uppercase tracking-widest">Secure Stadium Access</p>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {[
                        ...
                        { id: 'maintenance', label: 'Maintenance', icon: Wrench, color: 'bg-[#BE3455]/10 text-[#BE3455]' },
                        { id: 'dashboard', label: 'Notices', icon: Bell, color: 'bg-[#BE3455]/10 text-[#BE3455]' },
                      ].map((link) => (
                        <button
                          key={link.label}
                          onClick={() => {
                          ...
                          className="p-6 rounded-3xl bg-white/[0.03] border border-white/5 hover:border-[#BE3455]/30 transition-all group text-center"
                        >
                      ...
                      <div className="mt-10 pt-10 border-t border-white/10">
                        <div className="flex items-center justify-between mb-6">
                          <div className="flex items-center gap-2">
                            <Zap className="w-4 h-4 text-[#BE3455]" />
