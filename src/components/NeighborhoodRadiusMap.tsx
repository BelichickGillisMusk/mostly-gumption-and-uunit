  ...
  return (
    <div className="relative w-full aspect-square max-w-xl mx-auto flex items-center justify-center overflow-hidden">
      ...
      {[0.2, 0.4, 0.6].map((radius, i) => (
        ...
        >
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 px-2 py-0.5 bg-[#0F0F1A] text-[8px] font-bold text-white/20 uppercase tracking-widest">
            {radius} MI
          </div>
        </motion.div>
      ))}
      ...
      <div className="relative z-10">
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
          className="w-16 h-16 bg-app-accent rounded-full flex items-center justify-center shadow-[0_0_40px_rgba(196,30,58,0.6)] border-4 border-[#0F0F1A]"
        >
          ...
          >
            <div className="relative group">
              ...
              <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                <div className="px-3 py-1 bg-white text-[#0F0F1A] rounded-lg text-[10px] font-bold whitespace-nowrap shadow-2xl">
